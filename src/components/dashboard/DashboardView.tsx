...
import { BudgetTrackingCard } from "@/components/dashboard/BudgetTrackingCard";
...
function DashboardContent({ data, wallets, currentView, params }: { data: any, wallets: any[], currentView: string, params:any }) {
    ...
    return (
        ...
        {/* Insight teaser -- the full panel (with AI analysis + talking points)
            lives on the Analytics page; this is just a one-line pointer to it. */}
        <InsightTeaser data={insightsQuery.data} isLoading={insightsQuery.isLoading} />

        {/* Summary (period filter removed -- always Month to Date) */}
